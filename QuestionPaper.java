...
import javax.swing.*;  
  //online question paper
	...
	class Questionpaper extends JFrame implements ActionListener  
	{  
	    JLabel l;  
	    ...
	    {  
	        ...
	        {  
	            ...
	            jb[0].setText("init");jb[1].setText("main");jb[2].setText?;  
	    ...
	    {  
	        new Questionpaper("Online Test Of Java");  
	    }  
	}  
